...
> To find updates for XPRT, you can check the dedicated page on the Persistence One blog.
...
`
  ...
  return (
        <Box display="flex" flex="1" overflow="hidden" flexDirection={{ base: "column", xl: "row" }}>
          ...
          {hideFirstHeading && (
            <>
              <Heading as="h1" size={{ base: "xl", md: "2xl" }} mb={description ? 2 : 4} color={themeColors.text[700]}>XPRT Token</Heading>
            </>
          )}
              {description && (
