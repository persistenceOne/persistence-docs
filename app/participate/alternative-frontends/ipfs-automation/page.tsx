...
export const metadata = {
  title: 'IPFS Automation - Persistence Docs',
  description: '',
}

export default function Page() {
  const content = `# IPFS Automation
...
> ℹ️ **Info:** **Note:** This tool is open-sourced by [Kitkat Validator](https://kitkat.zone/).
...
#### **Step 2:** Install the dependencies with [\`npm install\`](/docs/participate/alternative-frontends/#user-content-fn-1)[^1]
...
<figure><img src="/images/Screenshot 2024-03-26 at 2.39.14 PM.png" alt=""><figcaption></figcaption></figure>
