...
**Step 2:** Install the dependencies with [\`npm install\`](/participate/alternative-frontends/#user-content-fn-1)[^1]
...
`
  ...
  return (
        <Box display="flex" flex="1" overflow="hidden" flexDirection={{ base: "column", xl: "row" }}>
          ...
          {hideFirstHeading && (
            <Heading as="h1" size={{ base: "xl", md: "2xl" }} mb={4} color={themeColors.text[700]}>IPFS Automation</Heading>
          )}
