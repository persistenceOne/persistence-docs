...
import {Box, Container, Heading, Text, Link, useColorMode} from '@chakra-ui/react'
...
`
  ...
  return (
        <Box display="flex" flex="1" overflow="hidden" flexDirection={{ base: "column", xl: "row" }}>
          ...
          {hideFirstHeading && (
            <Heading as="h1" size={{ base: "xl", md: "2xl" }} mb={4} color={themeColors.text[700]}>Grants</Heading>
          )}
              {description && (
