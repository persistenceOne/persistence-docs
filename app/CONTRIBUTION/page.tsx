...
export const metadata = {
  title: 'Contribution - Persistence Docs',
  description: '',
}
...
1. For requesting or adding a new documentation consider the following things:
    ...
    - If the documentation in concern belongs to another repository then consider the above points and reference the issue on the said repository in your [Pull request](/docs/#pull-request).
...
2. After a thoughtfull discussion, in case a change is required you will have to follow the [steps](/docs/#pull-request) for raising a pull request.
...
4. Consider looking at the [best practices](/docs/#best-practices) before you begin adding or editing the documentation.
...
- **Checks**
    ...
    - [ ] followed the [Best Practices](/docs/#best-practices)
