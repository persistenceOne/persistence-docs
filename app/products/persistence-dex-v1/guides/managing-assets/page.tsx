...
<figure><img src="..//images/Withdraw.png" alt=""><figcaption></figcaption></figure>

* **Step 2** - Enter the preferred amount to withdraw and click "Withdraw" button on the popup.

<figure><img src="..//images/Screenshot 2023-03-26 at 4.36.43 PM.png" alt=""><figcaption></figcaption></figure>
...
`
  ...
  return (
        <Box display="flex" flex="1" overflow="hidden" flexDirection={{ base: "column", xl: "row" }}>
          ...
          {hideFirstHeading && (
            <ChakraHeading as="h1" size={{ base: "xl", md: "2xl" }} mb={4}>Managing Assets</ChakraHeading>
          )}
