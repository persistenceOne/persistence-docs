...
Upgrading a live running persistence chain on a node to a new upgrade version binary (with latest application code) is a critical process.      
There are two ways to manage node upgrades:  
<table data-card-size="large" data-view="cards"><thead><tr><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><strong>Upgrade Using Cosmovisor</strong></td><td><a href="cosmovisor.md">cosmovisor.md</a></td></tr><tr><td><strong>Upgrade manually(without cosmovisor)</strong></td><td><a href="manual-upgrade.md">manual-upgrade.md</a></td></tr></tbody></table>
