...
Before being able to update our nodes, **Cosmovisor** needs to be configured acccordingly so it can run our Persistence test-core-1 node. Please continue with the following instructions:
